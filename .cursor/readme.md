for now, can you use this code to create the website : 'use client'
...
which this will be for the homepage and change the headers to be such as Home, about us, program, sponsors, recruitment, contact.

Then empty the lower pages for now besides the home page.

after working on this carefully, push it to 
this branch : git remote add origin https://github.com/haminxx/UCSD-x-CRS-website.git
git branch -M main
git push -u origin main

and then let'sgo through the firebase login and connect it to a project that's called UCSDxCRS if you can do ityourself, otherwise,guid me step bystep how canIdo itmyself.

carefully apply this for me.