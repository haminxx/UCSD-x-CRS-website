  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-20">
        ...
        >
          <div className="relative mx-auto aspect-[4/5] w-full max-w-md overflow-hidden rounded-[1.5rem] border border-[#F5F0E6]/10 bg-[#F5F0E6] shadow-[0_24px_80px_-32px_rgba(0,0,0,0.65)] md:rounded-[1.75rem] lg:mx-0 lg:max-w-none">
            <Image
        ...
        >
          <h2 className="text-[clamp(2rem,4.5vw,3.5rem)] font-bold tracking-tight text-[#F5F0E6] leading-[1.05]">
            What is CRS?
          </h2>
          <p className="mt-6 max-w-xl text-base leading-relaxed text-[#F5F0E6]/65 md:mt-8 md:text-lg">
