...
export const HoverPeek = ({
  ...
  const triggerChild = React.isValidElement(children) ? (
    React.cloneElement(children as React.ReactElement<TriggerChildProps>, {
      className: cn(
        (children as React.ReactElement<TriggerChildProps>).props.className,
        className,
      ),
            ...
            {isPeeking && (
              ...
              >
                ...
                >
                  {imageLoadFailed ? (
                    <div
                      className="flex items-center justify-center bg-neutral-100 font-sans text-xs text-neutral-500 dark:bg-neutral-800 dark:text-neutral-400"
                    ...
                    <img
                      ...
                      width={peekWidth}
                      height={peekHeight}
                      className="pointer-events-none block align-top rounded-[5px] bg-neutral-50 dark:bg-neutral-800"
                        ...
                        >
                          ...
                          >
                            <img
                              ...
                              width={peekWidth}
                              height={peekHeight}
                              className="block align-top rounded-[5px] bg-neutral-50 dark:bg-neutral-800"
                              alt=""
                              aria-hidden="true"
                            />
                          </div>
