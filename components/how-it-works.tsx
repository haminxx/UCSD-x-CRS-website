  ...
  return (
    ...
    >
      <motion.div
        ...
        className="mx-auto max-w-7xl overflow-hidden rounded-[1.75rem] bg-[#1a2229] px-8 py-14 text-white md:rounded-[2rem] md:px-12 md:py-20 lg:px-16 lg:py-24"
      >
          ...
          {STEPS.map((step, i) => (
            ...
            >
              <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                <span className="font-mono text-sm tracking-wide text-white/40">
                  / {step.num}
                </span>
              ...
              <p className="mt-4 max-w-sm text-[0.95rem] leading-relaxed text-white/55 md:text-base">
                {step.body}
              </p>
            </motion.div>
          ))}
