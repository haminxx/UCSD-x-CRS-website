...
export function HowItWorks({
  ...
  return (
    <section
      ...
      className={
        className ??
        "bg-[#F2F0EF] px-4 pb-24 pt-8 md:px-8 md:pb-32 md:pt-12 lg:px-12"
      }
    >
      <motion.div
        ...
        className="mx-auto max-w-7xl overflow-hidden rounded-[1.75rem] bg-[#1a2229] px-8 py-14 text-[#F2F0EF] md:rounded-[2rem] md:px-12 md:py-20 lg:px-16 lg:py-24"
      >
          ...
          {STEPS.map((step, i) => (
            ...
            >
              <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                <span className="font-mono text-sm tracking-wide text-[#F2F0EF]/40">
                  / {step.num}
                </span>
              ...
              <p className="mt-4 max-w-sm text-[0.95rem] leading-relaxed text-[#F2F0EF]/55 md:text-base">
                {step.body}
              </p>
            </motion.div>
          ))}
