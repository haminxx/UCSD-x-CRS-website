      ...
      <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pb-16 pt-28 text-[#F2F0EF] md:pt-32">
        ...
        <PageEnter className="relative z-10 w-full max-w-md">
          <form onSubmit={handleSubmit} className="flex flex-col">
            <p className="font-mono text-[11px] tracking-[0.22em] text-[#F2F0EF]/45 uppercase">
            ...
            <div className="mt-16 space-y-10">
              <label className="block">
                <span className="font-mono text-[11px] tracking-[0.2em] text-[#F2F0EF]/45 uppercase">
                  User identity
                </span>
                <input
                  id="email"
                  ...
                  className={cn(
                    ...
                    "outline-none ring-0 focus:border-[#F2F0EF]/80",
                  )}
                />
              </label>
            ...
            <button
              type="submit"
              className="mt-12 w-full rounded-full bg-[#182B49] py-4 text-sm font-bold tracking-[0.14em] text-[#F2F0EF] uppercase transition hover:bg-[#121F38]"
            >
              Initialize stream
            </button>

            <div className="mt-10 flex items-center justify-between gap-4 font-mono text-[11px] tracking-[0.16em] text-[#F2F0EF]/45 uppercase">
              <Link href="#" className="transition hover:text-[#F2F0EF]/80">
                Encrypted recovery
              </Link>
              <Link href="#" className="transition hover:text-[#F2F0EF]/80">
                Create an Account
